                ...
                <TableBody>
                    {rows.map((row) => (
                        <TableRow key={row.id}>
                            ...
                            <TableCell>
                                <Button className={classes.button} onClick={openDialogue}>
                                    {rentState.text}
                                </Button>
                            </TableCell>
                            <Dialog
                            ...
                            >
                                ...
                                <DialogContent>
                                    <DialogContentText id="alert-dialog-description">
                                        ...
                                        <ul>
                                            ...
                                            <li>$9 per hour</li>
                                            <li>
                                                portion of hour used charged full price of hour $25
                                                if returned to different dock
                                            </li>
                                        ...
                                        inherent dangers, including the risk of bodily injury and/or
                                        death. Renter assumes and accepts all risks associated with
                                        the use of the bicycle.
                                        <br></br>
                                        <br></br>
                                        2. If at any time THE BICYCLE SELLER determines that Renter
                                        has engaged in an unsafe or hazardous use of the bicycle,
                                        THE BICYCLE SELLER may immediately terminate the rental.
                                        Upon notification of termination, Renter must return the
                                        bicycle to the designated return area immediately. If the
                                        rental is terminated for unsafe or hazardous use, Renter
                                        will not be refunded his/her security deposit. THE BICYCLE
                                        SELLER shall determine, in its sole discretion, whether any
                                        behavior or activity is “unsafe or hazardous.”
                                        <br></br>
                                        <br></br>
                                        3. Condition of Bicycle upon Return. The Renter shall return
                                        the bicycle to the designated return area clean and in the
                                        same condition as it was in when given to Renter, excepting
                                        ordinary wear and tear. Renter shall be responsible for any
                                ...
                                <DialogActions>
                                    ...
                                    <Button onClick={agreeDialogue} color="primary" autoFocus>
                                        Agree
                                    </Button>
                                </DialogActions>
                            </Dialog>
